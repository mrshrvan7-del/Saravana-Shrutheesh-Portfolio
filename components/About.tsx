...
export default function About() {
  ...
  return (
    <section id="about" className="section-container section-padding bg-[#F5F0D8] relative overflow-hidden" ref={sectionRef}>
      
      {/* Background Globe/Coordinates SVG */}
      <svg className="absolute right-0 bottom-0 w-[300px] h-[300px] md:w-[500px] md:h-[500px] opacity-[0.05] pointer-events-none translate-x-16 translate-y-16 text-[#1A1A0A]" viewBox="0 0 400 400" fill="none" stroke="currentColor">
      ...
      <div className="w-full mb-20 bg-[#F5F0D8] rounded-3xl md:rounded-full border border-[#3D3A1A]/10 shadow-[inset_0_1px_2px_rgba(61,58,26,0.05),_0_8px_30px_rgba(61,58,26,0.03)] p-6 md:p-8 flex flex-col md:flex-row items-stretch justify-between gap-8 md:gap-4 animate-on-scroll fade-up">
        {/* Stat 1 */}
        <div className="flex-1 flex items-start gap-4">
          <div className="w-12 h-12 rounded-full border border-[#3D3A1A]/10 flex items-center justify-center text-[#8A7C38] shrink-0 bg-transparent">
            <Briefcase className="w-5 h-5" />
          </div>
          <div className="flex flex-col text-left">
            <span className="text-[22px] md:text-[24px] font-extrabold text-[#1A1A0A] leading-none">1.8+</span>
        ...
        <div className="flex-1 flex items-start gap-4">
          ...
          <div className="flex flex-col text-left">
            <span className="text-[22px] md:text-[24px] font-extrabold text-[#1A1A0A] leading-none">2</span>
            <span className="text-[13px] font-bold text-[#1A1A0A] mt-1.5">Global Giants</span>
            <span className="text-[11px] text-[#5A5530] font-medium leading-tight mt-0.5">Walmart Global Tech & Toyota India</span>
          </div>
        </div>
        ...
        <div className="flex-1 flex items-start gap-4">
          ...
          <div className="flex flex-col text-left">
            <span className="text-[22px] md:text-[24px] font-extrabold text-[#1A1A0A] leading-none">10+</span>
            <span className="text-[13px] font-bold text-[#1A1A0A] mt-1.5">Dashboards Built</span>
            <span className="text-[11px] text-[#5A5530] font-medium leading-tight mt-0.5">Power BI • BigQuery • Insights</span>
          </div>
        </div>
        ...
        <div className="flex-1 flex items-start gap-4">
          ...
          <div className="flex flex-col text-left">
            <span className="text-[22px] md:text-[24px] font-extrabold text-[#1A1A0A] leading-none">AI-Driven</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start relative z-10">
        ...
        <div className="lg:col-span-7 flex flex-col justify-start animate-on-scroll fade-up" style={{ transitionDelay: '150ms' }}>
          ...
          <span className="font-mono text-[11px] tracking-wider text-[#8A7C38] uppercase font-bold mb-3">WHO I AM</span>
          
          <h3 className="font-display font-extrabold text-[32px] sm:text-[40px] md:text-[48px] text-[#1A1A0A] leading-[1.1] tracking-tight mb-8">
            I turn complexity into clarity <br />
            and data into <span className="text-[#8A7C38]">decisions.</span>
          </h3>

          <div className="space-y-6 text-[15px] sm:text-[16px] leading-relaxed text-[#3D3A1A]">
            <p>
              I am a results-driven Business Analyst and Operations Strategist with over 1.8 years of experience driving operational excellence at global leaders like <span className="text-[#8A7C38] font-semibold">Walmart Global Tech</span> and <span className="text-[#8A7C38] font-semibold">Toyota Motors India</span>.
            </p>
            <p>
        ...
        <div className="lg:col-span-5 flex flex-col justify-start animate-on-scroll fade-up" style={{ transitionDelay: '300ms' }}>
          ...
          <div className="p-8 bg-[#F5F0D8] border border-[#3D3A1A]/10 rounded-2xl shadow-[0_4px_30px_rgba(61,58,26,0.02)]">
            <span className="font-mono text-[11px] tracking-wider text-[#8A7C38] uppercase font-bold mb-8 block">WHAT I BRING</span>
            
            <ul className="space-y-8">
              {/* Item 1 */}
              <li className="flex items-start gap-4">
                <div className="p-2 border border-[#3D3A1A]/10 rounded-lg text-[#8A7C38] flex-shrink-0 mt-0.5 bg-transparent">
