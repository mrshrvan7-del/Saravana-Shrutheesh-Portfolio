        ...
        <div className="timeline-item animate-on-scroll fade-up" style={{ transitionDelay: '150ms' }}>
          ...
          <div className="timeline-content">
            ...
            <ul className="timeline-bullets" style={{ marginTop: '0.5rem' }}>
              ...
              <li>
                <strong>Ai-Call-Auditor (Fully Built)</strong> &mdash; Proposed and successfully built Ai-Call-Auditor, an AI-powered call auditing system designed to automatically analyze and evaluate sales and customer support call recordings, leveraging NLP to extract customer sentiment, compliance flags, and key campaign performance metrics.
              </li>
              <li>
